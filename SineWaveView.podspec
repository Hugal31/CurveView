...
Pod::Spec.new do |s|
  s.name             = 'SineWaveView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SineWaveView.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Hugal31' => 'hugo.laloge@epitech.eu' }
  s.source           = { :git => 'https://github.com/Hugal31/SineWaveView.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'SineWaveView/Classes/**/*'

  # s.resource_bundles = {
  #   'SineWaveView' => ['SineWaveView/Assets/*.png']
  # }
